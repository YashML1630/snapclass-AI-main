...
def student_dashboard():
    ...
    for i, sub_node in enumerate(subjects):
        ...
        def unenroll_button():
            if st. button("Unroll from these course",type='tertiary',width='stretch',icon=':material/delete_forever:'):
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder="e.g. Yashraj Mohite")
            ...
            try:
                audio_data = st.audio_input('Record a short phrase like I am present, my name is Yashraj.')
            except Exception:
