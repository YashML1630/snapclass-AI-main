    ...
    with c2:
        ...
        if st.button(
            ...
            with st.spinner(
                ...
                # ====================================================
                # FIRST GET STUDENTS ENROLLED IN THIS SUBJECT
                # ====================================================
                ...
                # ====================================================
                # CREATE SET OF VALID STUDENT IDs
                # ====================================================
                ...
                for idx, img in enumerate(
                    ...
                    for sid, match_info in detected.items():
                ...
                st.info(
                    ...
                    f"Recognized enrolled students: "
                    f"{total_faces_recognized}"
                )
...
def login_teacher(username,password):
    ...
    if teacher:
        ...
        st.session_state.is_teacher_loged_in = True
        return True
    return False
...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username = st.text_input("Enter the username",placeholder="Shyamsingharoy")
...
def register_teacher(teacher_username,teacher_name,teacher_pass,teeacher_pass_confirm):
    if not teacher_username or not teacher_name or not teacher_pass:
        return False, "All fields are required!"
    if check_teacher_exist(teacher_username):
        return False, "Username is already taken"
    if teacher_pass != teeacher_pass_confirm:
        return False, "Password doesn't match"
    try:
        create_teacher(teacher_username,teacher_pass,teacher_name)
        return True, "Sucessfully created! Register now"
...
def teacher_screen_register():
    ...
    st.space()
    teacher_username = st.text_input("Enter the username",placeholder="Shyamsingharoy")
    teacher_name = st.text_input("Enter the name",placeholder="Shyamsingharoy")
    teacher_pass = st.text_input("Enter password",type="password",placeholder="Enter password")
    ...
    with btnc1:
        if st.button("register now",icon=":material/passkey:",shortcut="control+enter",width="stretch"):
            sucess,messege = register_teacher(teacher_username,teacher_name,teacher_pass,teacher_pass_confirm)
            if sucess:
                st.success(messege)
                import time
                time.sleep(2)
